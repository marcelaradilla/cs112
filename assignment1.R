...
plot(years,means,pch=16,col='blue',xlab='Year',ylab='Mean Duration(days)',main='Durations at Approval (2008-2018)')
#par(new=TRUE)
...
plot(years,b.meandifferences,pch=16,col='blue',xlab='Year',ylab='Difference (days)',main='Duration at Approval and Actual Duration')
